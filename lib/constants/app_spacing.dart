...
class AppSpacing {
  ...
  static double alertDialogInsetPadding = 20;
  static double containerPadding = 10;

  static Widget verticalSpaceTeenyTiny = SizedBox(height: 2.h);
  ...
  static Widget horizontalSpaceTeenyTiny = SizedBox(width: 2.w);
